...
export function DayOperations({ defaultDay = 1 }) {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="p-4 bg-white border border-[#e2e8f0]">
          ...
          <div className="mt-3 pt-2 border-t border-[#f1f5f9] flex justify-between text-xs text-[#64748b]">
            ...
            <span className="font-bold text-red-600 font-mono">
              {dayFin.expenses.length} Records
            </span>
          </div>
        </Card>
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-emerald-600 mt-1 font-mono">
                {formatCurrency(dayFin.netIncome)}
              </h3>
            </div>
      ...
      {/* 4. PRODUCT STOCK & QUANTITY SPECIFICATION TABLE */}
      ...
      {/* 5. One Counter & Kitchen Execution Flow */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Left: One Counter Flow */}
            ...
            <div className="pt-2 flex justify-end">
              <Link to="/one-counter">
                <Button variant="outline" size="sm" rightIcon={<ArrowRight className="w-3.5 h-3.5" />}>
                  Open Full Screen Counter Controller
                </Button>
              </Link>
            </div>
          </CardContent>
